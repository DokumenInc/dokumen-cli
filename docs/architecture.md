...
The presentation-ready path is local, standalone, and SDK-backed:
...
- The CLI does not fetch agents, tools, instructions, or credentials from a
...
- run results for dashboards and automation,
