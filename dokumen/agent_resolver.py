...
def format_skills_for_prompt(
    ...
    Each item is a (name, content, source) tuple where source indicates origin.
...
def collect_skills(
    ...
    """Collect reusable instructions from local scaffold and bundled sources.
    ...
    # Source A: Scaffold instructions (resolved via SkillLoader from workspace)
    ...
    # Source B: system skills from dokumen.skills.loader (inline mode only)
