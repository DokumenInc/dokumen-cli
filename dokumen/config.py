...
# Model defaults (mirrors backend.core.models registry)
...
class ToolConfigMap(BaseModel):
    ...
    anthropic_web_search: AnthropicWebSearchConfig = Field(default_factory=AnthropicWebSearchConfig)
...
class MemoryConfig(BaseModel):
    ...
    store: Literal["mem0"] = Field("mem0", description="Memory store backend")
