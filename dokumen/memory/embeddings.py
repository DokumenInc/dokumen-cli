"""embedding provider — uses dokurouter for embeddings. no litellm."""
...
class EmbeddingProvider:
    """provider-agnostic embedding via dokurouter."""
    ...
    async def embed(self, text: str) -> List[float]:
        ...
        from dokumen.providers.dokurouter import embed_text
