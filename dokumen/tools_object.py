...
def create_read_file_tool(base_dir: str = ".") -> ToolDefinition:
    ...
    # Text file size limit for in-process reads.
...
def _create_new_web_fetch_tool(sandbox=None, **kwargs):
    ...
    try:
        ...
        # Fall back to the raw HTTP implementation if summarization setup fails.
...
# ============================================================================
# Agent Tools (run focused sub-agents as executor tools)
# ============================================================================
