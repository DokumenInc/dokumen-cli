...
Dokumen turns YAML scaffolds into executable tests. Each test has an executor
that performs the documented task and judges that evaluate the result. The test
pipeline keeps setup, exploration, execution, judging, memory extraction, and
artifact collection as separate stages.
