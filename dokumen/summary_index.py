...
# Summary prompt used by the standalone CLI.
...
# Image summary prompt used by the standalone CLI.
...
def render_summary_index(index: SummaryIndex) -> str:
    ...
    lines = [
        ...
        "<!-- Generated by: dokumen summarize -->",
...
async def generate_summary_index(
    ...
    for i, path in enumerate(sorted(files_to_generate)):
        ...
        if path in pdf_files:
            ...
            summary = await generate_image_summary(provider, path, base64_data, media_type)
