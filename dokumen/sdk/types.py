...
class ExecutorResult:
    ...
    Used by executor agents, test_object.py, formatters, and the backend
    webhook handler. Replaces both the legacy ExecutorOutput and SdkExecutorResult.
...
class JudgeVerdict:
    ...
    Used by judge agents, test_object.py, formatters, and the backend
    webhook handler. Replaces both the legacy JudgeResult and SdkJudgeResult.
