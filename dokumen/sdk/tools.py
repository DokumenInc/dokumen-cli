...
UNSUPPORTED_SDK_TOOLS: Dict[str, str] = {
    "anthropic_web_search": (
        "anthropic_web_search is not supported in the Agent SDK path. "
        "Use web_search instead (Anthropic server-side search uses a different "
        "protocol than the SDK WebSearch tool)."
    ),
}
